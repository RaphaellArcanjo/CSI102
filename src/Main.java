...
public class Main {
    ...
    public static void main(String[] args) {
        cargaInicialDeDados(); // Adiciona dados iniciais para facilitar os testes
    ...
    private static void cadastrarProfessor() {
        ...
        try {
            ...
            System.out.print("Sigla do Departamento: ");
            String siglaDepto = scanner.nextLine();
            cadastroService.cadastrarProfessor(nome, email, cpf, senha, siape, siglaDepto);
    ...
    private static void cadastrarAluno() {
        ...
        cadastroService.cadastrarAluno(nome, email, cpf, senha, matricula, curso);
    ...
    private static void cargaInicialDeDados() {
        System.out.println("Carregando dados iniciais para demonstração...");
        try {
            // Departamentos
            cadastroService.cadastrarDepartamento("Departamento de Computação e Sistemas", "DECS");
            cadastroService.cadastrarDepartamento("Departamento de Engenharia Elétrica", "DEEL");

            // Professores
            cadastroService.cadastrarProfessor("Ana Silva", "ana.s@ufop.edu.br", "111", "123", "12345", "DECS");
            cadastroService.cadastrarProfessor("Bruno Costa", "bruno.c@ufop.edu.br", "222", "123", "67890", "DEEL");

            // Alunos
            cadastroService.cadastrarAluno("Carlos Andrade", "carlos@aluno.ufop.edu.br", "333", "123", "20.1.4001", "Ciência da Computação");
            cadastroService.cadastrarAluno("Daniela Faria", "daniela@aluno.ufop.edu.br", "444", "123", "19.2.5002", "Engenharia Elétrica");

            // Disciplinas
            cadastroService.cadastrarDisciplina("CSI102", "Programação Orientada a Objetos", 60, "DECS");
            cadastroService.cadastrarDisciplina("EEL200", "Circuitos Elétricos I", 90, "DEEL");

            // Monitorias
            monitoriaService.solicitarBolsa("CSI102", "12345", "20.1.4001", "Remunerada", "2025/2");
            monitoriaService.solicitarBolsa("EEL200", "67890", "19.2.5002", "Voluntaria", "2025/2");
            monitoriaService.cadastrarHorarioAtendimento("CSI102", "Qua 10h-12h", "Sala 205 - Bloco A");
            monitoriaService.cadastrarHorarioAtendimento("EEL200", "Sex 15h-17h", "Laboratório 3 - Bloco C");

            System.out.println("Carga inicial concluída com sucesso!");
        } catch (Exception e) {
            System.err.println("Ocorreu um erro na carga inicial de dados: " + e.getMessage());
        }
    }
}
